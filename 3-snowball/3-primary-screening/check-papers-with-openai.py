...
def main():
    input_csv = "3-snowball/3-primary-screening/snowball-primary-screening-start.csv"
    output_csv = "3-snowball/3-primary-screening/snowball-primary-screening-with-openai.csv"
    ...
    for idx, row in df.iterrows():
        ...
        suggestion = ask_openai(title, abstract)
        results.append(suggestion)
        time.sleep(1.5)  # To avoid hitting rate limits

    df["openai_suggestion"] = results
